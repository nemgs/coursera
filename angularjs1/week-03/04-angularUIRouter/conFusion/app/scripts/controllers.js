...
angular.module('confusionApp')
    ...
    .controller('DishDetailController', ['$scope', '$stateParams', 'distDetailFactory',
        function ($scope, $stateParams, distDetailFactory) {
            $scope.sortOrder = "-rating";
            $scope.dishDetail = distDetailFactory.getDish(parseInt($stateParams.id, 10));
